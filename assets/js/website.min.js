    ...
    function($window, $timeout) {
        ...
        function addObject($scope, $element, $attrs) {
            ...
            try {
                ...
                // add special CSS class if mobile sticky was anabled
                if (options.mobile) {
                    $element.addClass(settings.mobileClass);
                }
    ...
    function($timeout, Entertainment) {
        ...
        return {
            ...
            link: function($scope, $element, $attrs) {
                ...
                Entertainment.$onLetsDanceEvent(entertainmentEnv, function() {
                    instance.reloadSlider(angular.extend({}, settings, {
                        startSlide: instance.getCurrentSlide()
                    }));
